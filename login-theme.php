...
Description: Awesome login theme for WordPress Login page.
Version: 1.0.2
Author: pickplugins
...
define('login_theme_demo_url', 'http://pickplugins.com' );
define('login_theme_conatct_url', 'https://www.pickplugins.com/support/' );
define('login_theme_qa_url', 'https://www.pickplugins.com/support/' );
define('login_theme_plugin_name', 'Login Theme' );
define('login_theme_share_url', 'http://pickplugins.com/' );
